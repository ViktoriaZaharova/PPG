(function($){
  ...
  var i18n = {
      ...
      lv: {
          ...
          complete: 'Pabeigts',
          error: 'Kļūda',
          errorFilesLimit: 'Atlasīto failu skaits pārsniedz ierobežojumu  (%filesLimit%)',
          errorSizeLimit: 'Fails "%fileName%" pārsniedz lieluma ierobežojumu (%sizeLimit%)',
          errorFileType: 'Fails "%fileName%" ir nekorrekts',
          errorOldBrowser: 'Jūsu pārlūkprogramma nevar augšupielādēt failus. Atjaunināt uz jaunāko versiju'
      }
  };
